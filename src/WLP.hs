...
wlp (GCLD.TryCatch {}) _ = error "Try not implemented in wlp" -- do we go with method 1 error "not implemented" -- 2?

-- function needs clean-up...if we have time
repBy :: GCLD.Expr -> GCLD.Expr
repBy (GCLD.RepBy _ _ (GCLD.RepBy _ _ _)) = undefined -- AAssign
--Assign
